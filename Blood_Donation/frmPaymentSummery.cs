...
{
    public partial class frmPaymentSummery : Form
    {
        string con = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;

        public frmPaymentSummery()
        {
            InitializeComponent();
        }

        private void frmPaymentSummery_Load(object sender, EventArgs e)
        {

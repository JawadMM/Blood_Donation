...
{
    public partial class frmBloodTypeWIseCount : Form
    {
        string con = ConfigurationManager.ConnectionStrings["ConnectionString"].ConnectionString;
        public frmBloodTypeWIseCount()
        {
            InitializeComponent();
        }
        ...
        public void loadDataGrid()
        {
            using (SqlConnection connection = new SqlConnection(con))
            {
                ...
                string query = "select bl.BloodGroup,count(bu.DonationDate) AS count from BloodUnit bu inner join BloodType bl on bu.BloodTypeID = bl.BloodTypeID group by bl.BloodGroup ";
